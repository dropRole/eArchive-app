...
?>
<section id="studentRecord" class="p-3">
            ...
            <form id="iFrm">
                ...
                <div id="sojourns" class="px-3">
                    ...
                    <div class="d-flex justify-content-center col-12">
                        <button id="addSojourn" class="btn btn-outline-secondary" type="button">&plus;</button>
                    </div>
                </div>
                <div id="attendances" class="px-3 pb-3">
                    <p class="h4 pt-2">Podatki o študiranju</p>
                    <div class="d-flex justify-content-center col-12">
                        <button id="addAttendance" class="btn btn-outline-secondary" type="button">&plus;</button>
                    </div>
                </div>
            </form>
        </div>
