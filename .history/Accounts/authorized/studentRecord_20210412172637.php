                ...
                <div id="attendances" class="px-3 pb-3">
                    ...
                    <div id="rDiv" class="row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <select id="fSlct" class="form-control" name="attendances[0][faculties]" required>
                                <?php
                        ...
                        <div class="form-group col-4">
                            ...
                            <select id="pSlct" class="form-control" name="attendances[0][programs]" required>
                                <?php
