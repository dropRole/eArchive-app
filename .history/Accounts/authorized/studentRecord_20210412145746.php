        ...
        <div class="modal-content">
            <form id="iFrm">
                ...
                <div id="fundamentals" class="row px-3">
                    ...
                    <div class="form-group col-6">
                        <label for="pSlct">Kraj</label>
                        <select id="pSlct" class="form-control" name="id_postal_codes" required>
                            <?php
                    ...
                    <div class="form-group col-6">
                        ...
                        <select id="cSlct" class="form-control" name="id_countries" required>
                            <?php
                ...
                <div id="sojourns" class="px-3">
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            <label for="pSlct1">Kraj</label>
                            <select id="pSlct1" class="form-control" name="sojourns[id_postal_codes][0]" required>
                                <?php
                                $postalCodes = $DBC->selectPostalCodes($DBC->selectCountries()[0]->getIdCountries());
                                foreach ($postalCodes as $postalCode) {
                                ?>
                        ...
                        <div class="form-group col-4">
                            ...
                            <select id="cSlct1" class="form-control" name="sojourns[id_countries][0]" required>
                                <?php
                                $countries = $DBC->selectCountries();
                                foreach ($countries as $id_countries) {
                                ?>
