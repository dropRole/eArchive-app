            ...
            <form id="iFrm">
                ...
                <div id="attendances" class="px-3 pb-3">
                    ...
                    <div id="rDiv" class="row">
                        ...
                        <div class="form-group col-4">
                            <label for="eInpt">Vpisan</label>
                            <input id="eInpt" class="form-control" type="date" name="attendances[0][enrolled]">
                        </div>
                        <div class="form-group col-4">
                            <label for="iInpt">Indeks</label>
                            <input id="iInpt" class="form-control" type="input" name="attendances[0][index]">
                        </div>
