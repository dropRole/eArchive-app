                ...
                <div id="attendances" class="px-3 pb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <select id="fSlct" class="form-control" name="faculties[]">

                            </select>
                        </div>
                        <div class="form-group col-4">
                            <label for="pSlct"></label>
                            <select id="pSlct" class="form-control" name="programs[]">

                            </select>
                        </div>
                        <div class="form-group col-4">
                            <input id="gCb" type="checkbox">
                            <label for="gCb">Dimplomiral</label>
                        </div>
                    </div>
                    <div class="d-flex justify-content-center col-12">
