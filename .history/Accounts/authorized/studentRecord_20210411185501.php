...
<section class="container p-3">
    ...
    <div class="d-flex justify-content-end mr-3">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rMdl">Vstavi študenta</button>
        <button id="rBtn" class="invisible" type="button" data-toggle="modal" data-target="#rMdl"></button>
    </div>
                ...
                <div id="sojourns" class="px-3">
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <select id="mSlct" class="form-control" name="sojourns[municipality][0]" required></select>
                        </div>
                        <div class="form-group col-4">
