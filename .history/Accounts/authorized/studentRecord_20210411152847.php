                ...
                <div id="sojourns" class="px-3">
                    <div class="row">
                        <div class="form-group col-4">
                            ...
                            <input id="aInpt" class="form-control" type="text" name="address[]" required>
                        </div>
                        <div class="form-group col-4">
                            <label for="mSlct">Kraj</label>
                            <select id="mSlct" class="form-control" name="municipality[]" required></select>
                        </div>
                        <div class="form-group col-4">
                            <label for="cSlct">Država</label>
                            <select id="cSlct" class="form-control" name="country[]" required>
                                <?php
