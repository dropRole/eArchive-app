        ...
        <div class="modal-content">
            <form id="iFrm">
                ...
                <div id="fundamentals" class="row px-3">
                    ...
                    <div class="col-12">
                        <p class="h5">Podatki o bivališču</p>
                    </div>
                </div>
                <div id="sojourns" class="px-3">
                    <div class="row">
                    <p class="col-12 h6">Stalno bivališče</p>
                        ...
                        <div class="form-group col-4">
                            ...
                            <select id="pCSlct1" class="form-control" name="sojourns[0][id_postal_codes]" required>
                                <?php
                                $postalCodes = $DBC->selectPostalCodes($DBC->selectCountries()[0]->getIdCountries());
                                foreach ($postalCodes as $postalCode) {
                                ?>
                        ...
                        <div class="form-group col-4">
                            ...
                            <input id="aInpt" class="form-control" type="text" name="sojourns[0][address]" required>
                        </div>
                    </div>
                ...
                <div id="attendances" class="px-3 pb-3">
                    ...
                    <div id="rDiv" class="row">
                        ...
                        <div class="form-group col-4">
                            <label for="enrolled">Vpisan</label>
                            <input id="enrolled" class="form-control" type="date" name="attendances[0][enrolled]">
                        </div>
                        <div class="form-group col-4">
                            <label for="indx">Indeks</label>
                            <input id="idnx" class="form-control" type="input" name="attendances[0][index]">
                        </div>
