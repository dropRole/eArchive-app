...
(() => {
    ...
    cSlct.addEventListener('change', e => {
            propagateSelectElement(document.getElementById('pSlct'), '/eArchive/PostalCodes/select.php?id_countries=' + e.target.selectedOptions[0].value)
        }) // addEventListener
    ...
    function addSojourn() {
        ...
        aInpt.required = true
        pSlct.id = 'pSlct' + i
        pSlct.classList = 'form-control'
        pSlct.name = 'sojourns[id_postal_codes][' + i + ']'
        pSlct.required = true
        cSlct.id = 'cSlct' + i
        cSlct.classList = 'form-control'
        cSlct.name = 'sojourns[id_countries][' + i + ']'
        cSlct.required = true
            // attach event listener
        cSlct.addEventListener('change', e => {
                propagateSelectElement(pSlct, '/eArchive/PostalCodes/select.php?id_countries=' + e.target.selectedOptions[0].value)
            }) // addEventListener
