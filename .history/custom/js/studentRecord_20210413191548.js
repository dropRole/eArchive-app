...
(() => {
    ...
    function addSojourn() {
        ...
        p.textContent = `${sLblCntr}. začasno bivališče`
        ...
        aInpt.required = true
            // propagate countries by adding new sojourn
    ...
    function addAttendance() {
        ...
        let div = document.getElementById('attendances'),
            ...
            eInpt = document.createElement('div'),
            iInpt = document.createElement('div'),
        ...
        eLbl.setAttribute('for', `eLbl${aLblCntr}`)
        iLbl.textContent = 'Indeks'
        iLbl.setAttribute('for', `iLbl${aLblCntr}`)
        ...
        eInpt.id = `eInpt${aLblCntr}`
        eInpt.name = `attendances[${aIndx}][enrolled]`
        eInpt.required = true
        iInpt.className = 'form-control'
        iInpt.id = `eInpt${aLblCntr}`
