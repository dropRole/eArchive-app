...
(() => {
    ...
    function addAttendance() {
        ...
        let div = document.getElementById('attendances'),
            ...
            dSlct = document.createElement('select'),
            dInpt = document.createElement('select'),
            fInpt = document.createElement('select')
        ...
        pSlct.addEventListener('change', e => {
                propagateSelectElement(e, dSlct, '/eArchive/Offerings/selectOfferings.php')
            }) // addEventListener
