...
(() => {
    ...
    function addAttendance() {
        ...
        setTimeout(() => {
                propagateSelectElement(pSlct, '/eArchive/Programs/selectPrograms.php?id_universities=' + uSlct.selectedOptions[0].value) F
            }, 500) // setTimeout
        propagateSelectElement(oSlct, '/eArchive/Programs/selectOfferings.php?id_universities=' + uSlct.selectedOptions[0].value + '&id_programs=' + pSlct.selectedOptions[0].value)
