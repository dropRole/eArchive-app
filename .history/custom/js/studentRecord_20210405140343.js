...
(() => {
    ...
    function addSojourn() {
        ...
        xmlhttp.addEventListener('load', () => {
                ...
                cDiv.appendChild(fGDiv)
                cDiv.appendChild(fGDiv1)
                cDiv.appendChild(fGDiv2)
    ...
    function addAttendance() {
        ...
        gCb.addEventListener('change', addGraduation()) // addEventListener
        p.className = 'h6'
