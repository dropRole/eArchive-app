...
(() => {
    ...
    cSlct.addEventListener('change', e => {
            propagateSelectElement(e, document.getElementById('mSlct'))
        }) // addEventListener
    ...
    function addSojourn() {
        ...
        cSlct1.addEventListener('change', e => {
                propagateSelectElement(e, document.getElementById(mSlct1.id))
            }) // addEventListener
    ...
    function propagateSelectElement(e, mSlct, resource) {
        // create new instance
        let xmlhttp = new XMLHttpRequest(),
            id_countries = e.target.selectedOptions[0].value
        xmlhttp.addEventListener('load', () => {
                fragment = xmlhttp.response
        ...
        xmlhttp.responseType = 'document'
        xmlhttp.open('GET', '/eArchive/PostalCodes/selectPostalCodes.php?id_countries=' + id_countries)
        xmlhttp.send()
