...
(() => {
    ...
    function addAttendance() {
        ...
        fGDiv.className = 'form-group col-4'
        fGDiv1.className = 'form-group col-4'
        fGDiv2.className = 'form-group d-flex align-items-center justify-content-center col-4'
        uLbl.setAttribute('for', 'fSlct' + j)
        uLbl.textContent = 'Fakulteta'
