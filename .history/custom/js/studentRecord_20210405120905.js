...
(() => {
    ...
    function addAttendance() {
        ...
        setTimeout(() => {
                propagateSelectElement(document.getElementById('uSlct' + j), '/eArchive/Programs/selectPrograms.php?id_universities=' + document.getElementById('uSlct' + j).selectedOptions[0].value)
            }, 1000) // setTimeout
        ...
        div.appendChild(p)
        div.appendChild(div1)
        console.log(document.getElementById('uSlct' + j))
        j++
    } // addAttendance
})()