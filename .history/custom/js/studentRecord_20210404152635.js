...
(() => {
    ...
    function addSojourn() {
        ...
        cSlct1.addEventListener('change', e => {
                propagateSelectElement(document.getElementById('mSlct'), '/eArchive/PostalCodes/selectPostalCodes.php?selectPostalCodes.php=' + e.target.selectedOptions[0].value)
            }) // addEventListener
    ...
    function addAttendance() {
        ...
        let div = document.getElementById('attendances'),
            ...
            oInpt = document.createElement('input')
        ...
        pSlct.addEventListener('change', e => {
                propagateSelectElement(document.getElementById('mSlct'), '/eArchive/Offerings/selectOfferings.php?id_universtiies=' + uSlct.selectedOptions[0].value + '&id_programs=' + e.target.selectedOptions[0].value)
            }) // addEventListener
        p.className = 'h6'
