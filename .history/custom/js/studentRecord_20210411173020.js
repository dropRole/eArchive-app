...
(() => {
    ...
    var fragment = new DocumentFragment(),
        ...
        fSlcl = document.getElementById('fSlct'),
    ...
    fSlct.addEventListener('change', e => {
            propagateSelectElement(document.getElementById('pSlct'), '/eArchive/Programs/select.php?id_faculties=' + e.target.selectedOptions[0].value)
    ...
    function addSojourn() {
        ...
        let xmlhttp = new XMLHttpRequest(),
            ...
            mSlct = document.createElement('select'),
        ...
        aInpt.type = 'text'
        aInpt.name = 'sojourns[address][' + i + ']'
        aInpt.required = true
        mSlct.id = 'mSlct' + i
        mSlct.classList = 'form-control'
        mSlct.name = 'sojourns[municipality][' + i + ']'
        mSlct.required = true
        cSlct.id = 'cSlct' + i
        cSlct.classList = 'form-control'
        cSlct.name = 'sojourns[country][' + i + ']'
        cSlct.required = true
            // attach event listener
        cSlct.addEventListener('change', e => {
                propagateSelectElement(mSlct, '/eArchive/PostalCodes/select.php?id_countries=' + e.target.selectedOptions[0].value)
            }) // addEventListener
