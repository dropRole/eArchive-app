...
(() => {
    ...
    function addAttendance() {
        ...
        let div = document.getElementById('attendances'),
            ...
            // initial propagation
        propagateSelectElement(uSlct, '/eArchive/Universities/select.php')
        setTimeout(() => {
                propagateSelectElement(pSlct, '/eArchive/Programs/select.php?id_universities=' + uSlct.selectedOptions[0].value)
                setTimeout(() => {
                        propagateSelectElement(oSlct, '/eArchive/Offerings/select.php?id_universities=' + uSlct.selectedOptions[0].value + '&id_programs=' + pSlct.selectedOptions[0].value)
                    }, 500) // setTimetout
            }, 500) // setTimeout
        uSlct.addEventListener('change', e => {
                propagateSelectElement(pSlct, '/eArchive/Programs/select.php?id_universities=' + e.target.selectedOptions[0].value)
                setTimeout(() => {
                        propagateSelectElement(pSlct, '/eArchive/Programs/selectPrograms.php?id_universities=' + uSlct.selectedOptions[0].value)
                        setTimeout(() => {
                                propagateSelectElement(oSlct, '/eArchive/Offerings/selectOfferings.php?id_universities=' + uSlct.selectedOptions[0].value + '&id_programs=' + pSlct.selectedOptions[0].value)
                            }, 500) // setTimetout
                    }, 500) // setTimeout
            }) // addEventListener
        ...
        fGDiv3.appendChild(gCb)
        fGDiv3.appendChild(gLbl)
        p.appendChild(span)
        rDiv.appendChild(p)
        rDiv.appendChild(fGDiv)
        rDiv.appendChild(fGDiv1)
