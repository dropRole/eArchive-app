...
(() => {
    ...
    function addAttendance() {
        ...
        pSlct.addEventListener('change', e => {
                propagateSelectElement(oSlct, '/eArchive/Offerings/selectOfferings.php?id_universtiies=' + uSlct.selectedOptions[0].value + '&id_programs=' + e.target.selectedOptions[0].value)
            }) // addEventListener
        p.className = 'h6'
