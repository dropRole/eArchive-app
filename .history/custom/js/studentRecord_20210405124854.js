...
(() => {
    ...
    function addAttendance() {
        ...
        setTimeout(() => {
                ...
                setTimeout(() => {
                        propagateSelectElement(pSlct, '/eArchive/Offerings/selectOfferings.php?id_universities=' + uSlct.selectedOptions[0].value + '&id_programs=' + pSlct.selectedOptions[0].value)
                    }) // setTimetout
            }, 500) // setTimeout
