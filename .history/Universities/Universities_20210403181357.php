...
// table universities class definition
class Universities
{

    // encapsulation
    private $id_universities; // primary key
    ...
    private $headmaster; // multi-value attribute
    ...
    */
    public function __construct(int $id_universities, int $id_postal_codes, string $name, string $type, string $address, string $email, string $telephone, string $rector)
    {
    ...
    */
    ...
    /*
    *   set headmaster of a university
    *   @param string @headmaster   
    */
    public function setHeadmaster(string $headmaster){
        $this->headmaster = $headmaster;
    } // setHeadmaster

    // get headmaster of a university
