...
{
    private const AUTHORIZED = 'auth_611812494';
    private const PASS = 'gZ7NVqMHrE';

    // constructs class instance
    public function __construct(string $user = self::AUTHORIZED, string $pass = self::PASS)
    {
        try {
    ...
    */
    ...
    public function selectOfferings(int $id_universities, int $id_programs)
    {
        // result set
        $resultSet = [];
        $stmt = '   SELECT 
    ...
    public function checkAccountCredentials(string $index, string $pass)
    {
        ...
        try {
            ...
            if ($prpStmt->rowCount() == 1) {
                ...
                if (str_contains(self::AUTHORIZED, $index) && self::PASS == $pass) {
                    // register var and assign index
                    $_SESSION['authorized'] = 'auth_'. self::AUTHORIZED;
                    // register var and assign pass
