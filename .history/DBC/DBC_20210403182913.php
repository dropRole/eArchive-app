...
use PDO, PDOException, finfo, DateTime, Documents\Documents, PostalCodes\PostalCodes, Countries\Countries, Universities\Universities, Programs\Programs;
    ...
    */
    ...
    public function selectCountries()
    {
        ...
        try {
            ...
            $prpStmt = $this->prepare($stmt, [PDO::ATTR_CURSOR => PDO::CURSOR_FWDONLY]);
            $prpStmt->execute();
            $resultSet = $prpStmt->fetchAll(PDO::FETCH_CLASS | PDO::FETCH_PROPS_LATE, Countries::class, Countries::class->__construct());
        } // try
        catch (PDOException $e) {
            echo "Napaka: {$e->getMessage()}.";
        } // catch
