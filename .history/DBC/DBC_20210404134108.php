...
class DBC extends PDO
{
    ...
    */
    public function selectPostalCodes($id_countries)
    {
        // result set
        $resultSet = [];
        $stmt = '   SELECT 
    ...
    */
    public function selectPrograms($id_universities)
    {
        // result set
        $resultSet = [];
        $stmt = '   SELECT 
    ...
    public function selectOfferings($id_universities, id_programs)
    {
        // result set
        $resultSet = [];
        $stmt = '   SELECT 
