...
use PDO, PDOException, finfo, DateTime, Documents\Documents, PostalCodes\PostalCodes, Countries\Countries, Universities\Universities, Programs\Programs, Offerings\Offerings;

class DBC extends PDO
{
    private const SUPERUSER = 'authorized';
    ...
    */
    ...
    public function selectUniversities()
    {
        // result set
        $resultSet = [];
        $stmt = '   SELECT 
        ...
        try {
            ...
            $prpStmt = $this->prepare($stmt, [PDO::ATTR_CURSOR => PDO::CURSOR_FWDONLY]);
            $prpStmt->execute();
            $resultSet = $prpStmt->fetchAll(PDO::FETCH_CLASS | PDO::FETCH_PROPS_LATE, Universities::class, ['id_universities', 'id_postal_codes', 'name', 'type', 'address', 'email', 'telephone', 'headmaster']);
        } // try
        catch (PDOException $e) {
            echo "Napaka: {$e->getMessage()}.";
        } // catch
    ...
    /*
    *   select university offered programs 
    *   @param int $id_universities 
    */
    public function selectPrograms(int $id_universities)
    {
        // result set
        $resultSet = [];
        $stmt = '   SELECT 
                    ...
                    FROM 
                        ...
                        USING(id_universities)  
                    WHERE 
                        id_universities = :id_universities  ';
        try {
            // prepare, bind param to and execute stmt
            $prpStmt = $this->prepare($stmt, [PDO::ATTR_CURSOR => PDO::CURSOR_FWDONLY]);
            $prpStmt->bindParam(':id_universities', $id_universities, PDO::PARAM_INT);
            $prpStmt->execute();
            $resultSet = $prpStmt->fetchAll(PDO::FETCH_CLASS | PDO::FETCH_PROPS_LATE, Programs::class, ['id_programs', 'name', 'field']);
        } // try
        catch (PDOException $e) {
            echo "Napaka: {$e->getMessage()}.";
        } // catch
    ...
    /*
    *   select degrees of a program 
    *   @param int $id_universities
    *   @param int $id_programs
    */
    public function selectDegrees(int $id_universities, int $id_programs)
    {
        // result set
        $resultSet = [];
        $stmt = '   SELECT 
                    ...
                    FROM 
                        ...
                        USING(id_programs)
                    WHERE 
                        id_universities = :id_universities AND id_programs = :id_programs  ';
        try {
            // prepare, bind params to and execute stmt
            $prpStmt = $this->prepare($stmt, [PDO::ATTR_CURSOR => PDO::CURSOR_FWDONLY]);
            $prpStmt->bindParam(':id_universities', $id_universities, PDO::PARAM_INT);
            ...
            $prpStmt->execute();
            $resultSet = $prpStmt->fetchAll(PDO::FETCH_CLASS | PDO::FETCH_PROPS_LATE, Offerings::class, ['id_offerings', 'id_universities', 'id_programs', 'faculty', 'degree', 'duration']);
        } // try
        catch (PDOException $e) {
            echo "Napaka: {$e->getMessage()}.";
        } // catch
    ...
    /*
    *   select duration of a program 
    *   @param int $id_universities
    *   @param int $id_programs
    */
    public function selectDuration(int $id_universities, int $id_programs)
    {
        // result set
        $resultSet = [];
        $stmt = '   SELECT 
    ...
    /*
    *   select faculty of a program 
    *   @param int $id_universities
    *   @param int $id_programs
    */
    public function selectFaculty(int $id_universities, int $id_programs)
    {
        // result set
        $resultSet = [];
        $stmt = '   SELECT 
    ...
    */
    public function insertStudent(int $id_postal_codes, int $id_accounts, string $name, string $surname, string $email = NULL, string $telephone = NULL, $sojourns = [])
    {
        // result
        $report = '';
        $stmt = '   INSERT INTO 
    ...
    *   @param int $enrolled 
    */
    public function insertAttendances(int $id_students, int $id_universities, int $id_programs, DateTime $enrolled, int $index)
    {
        $stmt = '   INSERT INTO 
                        attendances 
                    (
    ...
    *   @param int $enrolled 
    */
    public function updateAttendaces(int $id_attendances, int $id_students, int $id_universities, int $id_programs, DateTime $enrolled, int $index)
    {
        $stmt = '   UPDATE 
                        attendances 
                    SET 
    ...
    *   @param string $telephone
    */
    public function insertMentorings(int $id_scientific_papers, int $id_universities, string $mentor, string $email, string $telephone)
    {
        $stmt = '   INSERT INTO 
                        mentorings
                    (
    ...
    *   @param string $telephone
    */
    public function updateMentorings(int $id_mentorings, int $id_scientific_papers, int $id_universities, string $mentor, string $email, string $telephone)
    {
        $stmt = '   UPDATE 
                        mentorings 
                    SET 
    ...
    public function checkAccountCredentials(string $index, string $pass)
    {
        ...
        try {
            ...
            if ($prpStmt->rowCount() == 1) {
                ...
                if (self::SUPERUSER == $index && self::PASS == $pass) {
                    // register var and assign index
                    $_SESSION['authorized'] = $index;
                    // register var and assign pass
                    $_SESSION['pass'] = $pass;
