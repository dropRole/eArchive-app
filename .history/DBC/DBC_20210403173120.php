...
use PDO, PDOException, finfo, DateTime, Documents\Documents, PostalCodes\PostalCodes, Countries\Countries, Universities\Universities;
...
class DBC extends PDO
{
    ...
    *   @param string $year
    */
    public function selectPapersByYear($year)
    {
        // result set
        $resultSet = [];
        $stmt = '   SELECT 
    ...
    */
    public function selectPrograms($id_universities)
    {
        ...
        try {
            ...
            $prpStmt->execute();
            $resultSet = $prpStmt->fetchAll(PDO::FETCH_CLASS | PDO::FETCH_PROPS_LATE, Programs::class, ['id_universities', 'id_postal_codes', 'name', 'type', 'address', 'email', 'telephone', 'headmaster']);
        } // try
        catch (PDOException $e) {
            echo "Napaka: {$e->getMessage()}.";
        } // catch
